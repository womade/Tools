$(function() { ({
        ...
        init: function() {
            ...
            this.composeContainer = $("#J-composeContainer"),
            this.canvasModel = $("#J-canvasModel"),
            this.speedSlider = $("#J-speedSlider"),
            this.addUploadBtn = $("#J-addUpload"),
            this.makerBtn = $("#J-makerBtn"),
            this.frameList = $("#J-frameList"),
        ...
        setOriginList: function() {
            ...
            e = 0; e < this.origins.length; e++) {
                ...
                t += '<li data-index="' + e + '">\t<div class="view-item-image">\t\t<img src="' + i.data + '"/>\t</div>\t<div class="delete-btn J-deleteBtn" data-index="' + e + '">\t\t<i class="iconfont icon-shanchu1"></i>\t</div>\t<div class="info">\t\t<input type="text" class="index" value="' + (e + 1) + '"/>\t\t<span class="name">' + i.name + "</span>\t</div></li>"
            }
        ...
        deleteViewList: function() {
            var t = this;
            t.frameList.on("click", ".J-deleteBtn",
            function() {
        ...
        setWidth: function() {
            ...
            function() {
                ...
                t.preview(),
                t.widthSelect.find(".J-widthInput").val(""),
                t.widthSelect.find(".J-heightInput").val("")
            }),
            t.widthSelect.find(".J-widthInput").on("input",
            function() {
                var e = $(this).val();
            ...
            t.widthSelect.find(".J-heightInput").on("input",
            function() {
                var e = $(this).val();
