$(function() { ({
        ...
        init: function() {
            ...
            this.doc = $(document),
            this.cutContainer = $("#J-cutContainer"),
            this.resultList = $("#J-resultList"),
            this.previewImage = $(".J-previewImage"),
            this.sourceBlock = $("#J-sourceBlock"),
            this.sourceArea = this.sourceBlock.closest(".cut-source"),
            this.previewArea = $("#J-preview"),
            this.makerBtn = $("#J-makerBtn"),
            this.againBtn = $("#J-uploadAgain"),
            this.widthSelect = $("#J-widthSelect"),
            this.widthInput = this.widthSelect.find(".J-widthInput"),
            this.heightInput = this.widthSelect.find(".J-heightInput"),
            this.cutInfo = $("#J-cutInfo"),
            this.upload(),
            this.start(),
            this.setRole(),
            this.deleteViewList()
        ...
        cutGif: function() {
            ...
            e = t.getParams(),
            i = new GIF({
                workerScript: "/plugins/gif/gif.help.js",
                background: "#ffffff",
                width: e.width,
                height: e.height,
                quality: 10,
            ...
            i.on("finished",
            function(i) {
                t.resultList.prepend('<li><div class="view-item-image"><img src="' + t.fileUrl.createObjectURL(i) + '" /></div><div class="delete-btn J-deleteBtn"><i class="iconfont icon-shanchu1"></i></div><a href="' + t.fileUrl.createObjectURL(i) + '" download="' + (new Date).getTime() + "_" + parseInt(e.width) + "x" + parseInt(e.height) + '">下载(' + parseInt(e.width) + "*" + parseInt(e.height) + ")</a></li>"),
        ...
        deleteViewList: function() {
            this.resultList.on("click", ".J-deleteBtn",
            function() {
