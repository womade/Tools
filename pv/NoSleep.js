          ...
          , i = function() {
            function A() {
                ...
                Q()) {
                    ...
                    C() ? this.noSleepTimer = null : (this.noSleepVideo = document.createElement("video"),
            ...
            return g(A, [{
                ...
                key: "disable",
                value: function() {
                    Q() ? (this._wakeLock && this._wakeLock.release(),
                    this._wakeLock = null) : C() ? this.noSleepTimer && (console.warn("\n          NoSleep now disabled for older iOS devices.\n        "),
