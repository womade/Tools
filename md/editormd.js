 ...
 * @file        editormd.js 
 * @version     v2.0.2.0
 * @description China Yuanzheng Markdown Editor.
 * @license     MIT License
 * @author      楊遠徵
 * {@link       https://t.ssss.fun/md}
...
;(function(factory) {
    ...
    editormd.title        = editormd.$name = "Markdown Editor";
    editormd.version      = "2.0.2.0";
    editormd.homePage     = "https://t.ssss.fun/md/";
    ...
    editormd.defaults     = {
        ...
        lang : {
            name        : "zh-cn",
            description : "中國遠徵 Markdown 编辑器<br/>China Yuanzheng Markdown Editor.",
            tocTitle    : "目录",
            toolbar     : {
                undo             : "撤销（Ctrl+Z）",
                redo             : "重做（Ctrl+Y）",
    ...
    editormd.prototype    = editormd.fn = {
        ...
        createInfoDialog : function() {
            ...
            var infoDialogHTML = [
                ...
                "<p style=\"font-size: 0.85em;\">Copyright &copy; 1998-" + editormd.dateFormat('yyyy') + " <a href=\"https://t.ssss.fun/md\" target=\"_blank\" class=\"hover-link\">中國遠徵</a>, The <a href=\"https://t.ssss.fun/md/LICENSE\" target=\"_blank\" class=\"hover-link\">MIT</a> License.</p>",
                "</div>",
